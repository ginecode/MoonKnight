    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(
            "Recent Search",
            style: TextStyle(fontSize: SizeConfig.screenHeight! / 37.95, fontWeight: FontWeight.w400),
          ),

          /// 18
          Text(
            "Clear All",
            style: TextStyle(color: lightColor, fontSize: SizeConfig.screenHeight! / 45.54),
          )
