...
import 'package:moonknight/food_ui/configuration/food_list.dart';
import 'package:moonknight/food_ui/view/cart_page/widgets/food_list_widget/delete_icon_button.dart';
import 'package:moonknight/food_ui/view/cart_page/widgets/food_list_widget/food_text.dart';
import 'package:moonknight/food_ui/view/cart_page/widgets/food_list_widget/food_image.dart';
            ...
            if (snapshot.hasData) {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      padding: EdgeInsets.symmetric(vertical: SizeConfig.screenHeight! / 68.3),
                      ...
                      child: Dismissible(
                        ...
                        background: Container(
                          padding: EdgeInsets.symmetric(horizontal: SizeConfig.screenWidth! / 20.55),
