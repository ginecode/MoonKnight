...
import 'package:moonknight/food_ui/view/checkout_page/checkout_page_view.dart';
    ...
    return InkWell(
      ...
      child: Container(
          ...
          child: Center(
            ...
            "Checkout",
            style:
                TextStyle(color: Colors.white, fontSize: SizeConfig.screenHeight! / 34.15, fontWeight: FontWeight.bold),
