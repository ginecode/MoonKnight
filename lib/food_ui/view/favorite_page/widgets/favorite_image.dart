...
class FavoriteDetail extends StatefulWidget {
  ...
  FavoriteDetail(
      {required this.food_image_name, required this.food_name, required this.food_category, required this.food_price});
...
class _FavoriteDetailState extends State<FavoriteDetail> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Container(
          height: SizeConfig.screenHeight! / 6.31,
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
              image: AssetImage("${widget.food_image_name}"),
              fit: BoxFit.cover,
            ),
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                    ...
                    fontSize: SizeConfig.screenHeight! / 50.69,
              ...
              Padding(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                      color: buttonColor,
                      fontSize: SizeConfig.screenHeight! / 50.95,
