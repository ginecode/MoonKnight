...
import 'package:moonknight/food_ui/view/favorite_page/widgets/favorite_cart_icon.dart';
import 'package:moonknight/food_ui/view/favorite_page/widgets/favorite_icon.dart';
import 'package:moonknight/food_ui/view/favorite_page/widgets/favorite_image.dart';
    ...
    return Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.symmetric(
            horizontal: SizeConfig.screenWidth! / 20.0, vertical: SizeConfig.screenHeight! / 136.6),
                  ...
                  child: Column(
                    children: [
                      ...
                      Center(
                          child: Text(
                        "Your Favorite Foods",
                        style: TextStyle(color: Colors.black12, fontSize: SizeConfig.screenHeight! / 34.15),
                      ))
