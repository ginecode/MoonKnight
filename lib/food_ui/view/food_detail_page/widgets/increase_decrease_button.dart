...
import 'package:moonknight/food_ui/view/food_detail_page/components/separator.dart';
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "Total",
            style: TextStyle(color: Colors.black54, fontSize: SizeConfig.screenHeight! / 42.69),
          ),
              ...
              Column(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(color: Colors.black, fontSize: SizeConfig.screenHeight! / 27.32),
                  )
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text(
                          "${_counter}",
                          style: TextStyle(fontSize: SizeConfig.screenHeight! / 37.95, fontWeight: FontWeight.bold),
                        ),
