        ...
        children: [
          Column(
            ...
            children: [
                ...
                children: [
                  Padding(
                    padding: EdgeInsets.only(
                        top: SizeConfig.screenHeight! / 85.38, bottom: SizeConfig.screenHeight! / 113.84),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      /// 30.0
                      decoration:
                          BoxDecoration(image: DecorationImage(image: AssetImage("assets/main/waving-hand.png"))),
                    ),
                  )
                ],
              ),
              Text(
                "Are you hungry?",
                style: TextStyle(fontSize: SizeConfig.screenHeight! / 40.18, color: Colors.black54),
              )
          ...
          Stack(
            children: [
              Container(
                ...
                /// 80.0
                decoration:
                    BoxDecoration(color: lightColor.withOpacity(0.5), borderRadius: BorderRadius.circular(30.0)),
              ),
              Container(
                  height: SizeConfig.screenHeight! / 17.07,
                  ...
                  /// 40.0
                  decoration:
                      BoxDecoration(color: buttonColor.withOpacity(0.5), borderRadius: BorderRadius.circular(30.0)),
                  child: Icon(
