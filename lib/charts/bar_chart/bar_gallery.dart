...
List<GalleryScaffold> buildGallery() {
  return [
    ...
    GalleryScaffold(
      ...
      subtitle: 'Grouped bar target line chart with multiple series and a single target',
    ...
    GalleryScaffold(
      listTileIcon: Transform.rotate(angle: 1.5708, child: const Icon(Icons.insert_chart)),
