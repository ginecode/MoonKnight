...
import '../../examples/image_slider/utils.dart';
...
class _ImageSliderState extends State<ImageSlider> {
  ...
  void _onTapDown(TapDownDetails details, int index) {
    ...
    final globalPositionInitCard = details.globalPosition.dx - details.localPosition.dx;
    ...
    if (globalPositionInitCard + cardMaxWidth > (MediaQuery.of(context).size.width - _padding * 2)) {
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                      ...
                      child: AnimatedContainer(
                        ...
                        width: index == _indexSelected ? cardMaxWidth : cardWidth,
    ...
    return Padding(
      ...
      child: Stack(
        children: [
          AnimatedPositioned(
            duration: _duration,
            bottom: widget.index == widget.indexSelected ? _containerSize?.height ?? 0 : 0,
            left: 0,
            right: 0,
            child: Text(
...
class _DotsState extends State<Dots> {
  ...
  void _listener() {
    final maxSizePerSection = (widget.cardWidth + widget.padding) * cardsPerSection;
  ...
  void _onTap(int index) {
    final cardPositionToMove = (widget.cardWidth + widget.padding) * (index * cardsPerSection);
    widget.scrollController.animateTo(
      cardPositionToMove.clamp(0, widget.scrollController.position.maxScrollExtent),
    ...
    return Row(
      ...
      children: List.generate(_dotsCount, (index) {
        return Dot(
          onTap: () => _onTap(index),
          backgroundColor:
              _selectedIndex == index ? Theme.of(context).primaryColor : Theme.of(context).colorScheme.background,
        );
      }),
    );
  }
