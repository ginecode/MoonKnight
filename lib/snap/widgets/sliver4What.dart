      ...
      child: Scaffold(
        ...
        body: CustomScrollView(
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Column(
                children: const [PhoneAndName(), ProfileIconButtons()],
              ),
            ),
        ...
        children: [
          Stack(
            children: [
              ...
              Positioned(top: 15, left: 90, child: displayPhoneNumber(relativeScroll70px)),
              Positioned(
                  top: 5,
    ...
    if (relativeFullScrollOffset >= 0.8) {
      return Transform(
        ...
        child: Text(
          "+3 3333333333",
          style: TextStyle(
            fontSize: phoneNumberFontSizeTween.transform((relativeFullScrollOffset - 0.8) * 5),
            color: Colors.white,
